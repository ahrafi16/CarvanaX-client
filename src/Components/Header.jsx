import car_logo from "../../public/car_logo.png";
        ...
        <nav className="bg-neutral-primary text-white fixed w-full z-20 top-0 start-0">
            <div className="flex flex-wrap items-center justify-between mx-auto px-6 md:px-20">
                <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src={car_logo} className="w-25 brightness-0 invert" alt="CarvanaX Logo" />
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-default rounded-base bg-neutral-secondary-soft md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-neutral-primary">
                        ...
                        <li>
                            <a href="#" className="block py-2 px-3 bg-brand rounded md:bg-transparent md:text-fg-brand md:p-0" aria-current="page">Add Cars</a>
                        </li>
                        <li>
